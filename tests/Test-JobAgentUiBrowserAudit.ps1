...
'@
    ...
    Assert-True -Condition ($detailReturnFocus.focus -eq 'job-detail-open') -Message 'Detailansicht: Der Fokus kehrt nicht zum zuvor geoeffneten Stellentitel zurueck.'
