...
Assert-True -Condition (@($coverageWithInputs.target_inventory_gate.violations | Where-Object { $_ -eq 'INVENTORY_CANDIDATES_BELOW_1000' }).Count -eq 0) -Message 'Zielinventar-Gate darf bei erreichter 1000er-Kandidatenbasis keine fehlende Kandidatenbasis melden.'
