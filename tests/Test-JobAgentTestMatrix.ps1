...
$expectedIds = @((2..15 | ForEach-Object { 'JA-{0:D3}' -f $_ }) + @('JA-024', 'JA-025', 'JA-026', 'JA-027', 'JA-027.2', 'JA-029'))
$items = @($matrix.items)
...
[pscustomobject]@{
    ...
    cases = @(
        'matrix_schema',
        'roadmap_id_coverage_ja002_to_ja015_and_ja024_to_ja027_2_and_ja029',
        'test_files_exist',
