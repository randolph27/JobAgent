...
function Get-InventoryTestReferences {
    ...
    $bySource = @{
        ...
        'src\JobAgent.Report.psm1' = @('tests\Test-JobAgentReport.ps1', 'tests\Test-JobAgentUiBrowserAudit.ps1', 'tests\Test-JobAgentHtmlAudit.ps1', 'tests\Test-JobAgentHtmlViewportAudit.ps1')
