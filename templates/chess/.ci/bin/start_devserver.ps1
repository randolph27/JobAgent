...
$cmd_str = "./gradlew :ui-web:jsBrowserDevelopmentRun --console=plain"
...
$json_content = '{ "ts":"' + (Get-Date).ToString("o") + '", "pid":' + $pid_val + ', "cmd":"' + $cmd_str + '", "cwd":"' + $cwd_val + '", "port":8080, "url":"http://localhost:8080/" }'
