...
# Bootstrap-Kompatibilitaet: Der gemeinsame Loader pinnt ausschliesslich
# ausfuehrbare Runtime-Dateien. README, Roadmap, TODO und Konfiguration bleiben
# bewusst mutable und werden separat validiert.
$ImmutableBaseFiles = @()
...
$bootstrapPreverified = [string]$env:CI_BOOTSTRAP_PREVERIFIED -eq "1"
$immutableRuntimeLock = $null
if (-not $bootstrapPreverified) {
