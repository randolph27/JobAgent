...
- [ ] JA-027 Automatische Firmenakquise beim regulaeren Jobstart mit sichtbarem WebIF-Bestand liefern #comment: Quellenzufuhr und Karriereverifikation in einem wiederaufnehmbaren Lauf verbinden; Fortschritt an neuen belegten Arbeitgebern statt an Reparatur- oder Importwellen messen.
  ...
  - [ ] JA-027.2 Quellen mit verwertbaren Website-/Karrierehinweisen priorisieren und die ausfuehrbare Queue automatisch nachfuellen.
    ...
    Ist-Stand (2026-09-13 10:15): 35 registrierte Quellen und 29 Snapshot-Manifesteintraege laut vorheriger Inventur; vor Umsetzung frisch abgleichen. Regionalparser hat keinen allgemeinen URLhinweistransport; bestehende Betriebsdokumentation beschreibt fuer mehrere Community-/OSM-Quellen den Verzicht auf Websitepersistenz. Aenderung benoetigt quellenspezifisch belegte Nutzungs-/Retentionregeln. Indeed MANUAL_REVIEW_ONLY, LinkedIn REJECT, HWK ohne Snapshotfreigabe, BioM ohne Snapshotvertrag und IHK ohne Export-/API-Freigabe bleiben gesperrt/geparkt. Kein neuer externer Quellencheck in diesem Planungsauftrag.
