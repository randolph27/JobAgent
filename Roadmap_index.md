...
Stand: 2026-09-15, nach Abschluss von UI-001 und Nutzerkorrektur zur berufsneutralen Suche.

- `Roadmap.md`: JA-042 wiederholbarer Betrieb. Genau drei detaillierte Unterpunkte. Keine manuellen Firmenwellen oder reale Firmenmindestmenge als Software-DoD.
...
- `Roadmap_archive.md`: historische Abschluesse einschliesslich UI-001, JA-041 und JA-027 (2026-09-15), JA-040/CI-001. Wiederverwendete IDs nur mit Titel/Datum interpretieren.
