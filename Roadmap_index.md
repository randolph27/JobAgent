...
Stand: 2026-09-15. Aktiver Plan: QA-003 bis QA-006 fuer den umfassenden Funktions-/UI-Supertest. QA-001 und QA-002 sind abgeschlossen und archiviert.

- `Roadmap.md`: QA-003 -> QA-004 -> QA-005 -> QA-006; der naechste Ausfuehrungsanker ist QA-003.1. Reale Firmenwellen bleiben kein Software-DoD.
...
- `Roadmap_archive.md`: historische Abschluesse einschliesslich QA-002 und QA-001 sowie JA-042, UI-001, JA-041 und JA-027 (2026-09-15), JA-040/CI-001. Wiederverwendete IDs nur mit Titel/Datum interpretieren.
