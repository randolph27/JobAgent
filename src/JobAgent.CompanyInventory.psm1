...
function Get-JobAgentCompanySeedInventory {
    ...
    @(
        New-JobAgentCompanySeed -CanonicalName 'BMW Group' -OfficialWebsiteUrl 'https://www.bmwgroup.com/' -CareerUrl 'https://jobs.bmwgroup.com/' -Aliases @('Bayerische Motoren Werke', 'BMW AG') -Locations @($munich) -Industry 'Automotive' -ScanPriority 95 -DiscoverySourceUrl 'https://jobs.bmwgroup.com/' -CreatedAt $CreatedAt -NextScanAt $NextScanAt
