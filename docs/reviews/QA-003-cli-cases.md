...
| `Invoke-JobAgentDailyRun.ps1` | zwei frische, bytegleiche isolierte Projektwurzeln mit dem Akquise- und Scan-Aufruf aus der ersten Zeile | Normalisierte SHA-256-Hashes der Firmen, Quellen, Stellen, des Kandidatencheckpoints sowie JSON-, Markdown- und HTML-Berichtsartefakte sind identisch. Lauf-IDs, UTC-Zeitstempel, Laufstempel und absolute Temp-Pfade sind als volatile Werte bewusst normalisiert. |
